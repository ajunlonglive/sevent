#ifndef SEVENT_NET_HTTP_HTTP_H
#define SEVENT_NET_HTTP_HTTP_H

namespace sevent {
namespace net {
namespace http {
/* Status Codes */
#define SEVENT_HTTP_STATUS_MAP(XX)                                                 \
...
/* Request Methods */
#define SEVENT_HTTP_METHOD_MAP(XX)         \
  XX(0,  DELETE,      DELETE)       \
  XX(1,  GET,         GET)          \
  XX(2,  HEAD,        HEAD)         \
  XX(3,  POST,        POST)         \
...
enum class HttpMethod {
    ...
    SEVENT_HTTP_METHOD_MAP(XX)
    #undef XX
};

enum class HttpStatus {
    #define XX(num, name, string) HTTP_STATUS_##name = num,
    SEVENT_HTTP_STATUS_MAP(XX)
    #undef XX
};
